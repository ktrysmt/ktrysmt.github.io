...
date: 2026-02-27 00:01:00 +0900
categories: Developer Tools
published: true
use_toc: false
description: "memd-cliをNeovim内で使えるプラグイン memd.nvim の紹介。バッファから直接Mermaid付きMarkdownをプレビューし、保存時に自動リロードする機能を搭載。"
tags:
  - neovim
  - cli-tools
  - node-js
...
以前 [memd-cli](https://ktrysmt.github.io/blog/mermaid-markdown-viewer/) という mermaid を ascii art として出力するcliを作ったのですが、Neovimからも使いやすくしたかったのでプラグインを書きました。
