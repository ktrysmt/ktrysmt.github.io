---
layout: post
title: "疲弊しないための、CloudFormation管理方針"
date: 2018-05-05
comments: true
categories: "AWS"
published: true
...
Outputに関連してCFnにはImportValueという仕組みがあり、これを使えば他のStackが特定のOutputに依存していることを知らずに当該Stackを編集・削除しようとた場合でも、ロックを掛けて更新の拒絶をしてくれます。コレ自体は便利でよいのですが、実際にOutputしたい情報としてはリソースIDぐらいしか需要がない点と、にもかかわらずOutputの出力は自由度が高いという点が、どうにも気がかりです。
Outputの一覧性も低く、全体的にデリケートな印象であまり使いたくないです。
