---
layout: post
title: "FISC安全対策基準 第13版の全体像 -- 6テーマ・130件の変更点とサイバーGL取込みの影響"
...
経済安全保障推進法の「特定社会基盤役務の安定的な提供の確保に関する制度」を受けたものらしい。ようするに金融機関が「特定社会基盤事業者」に指定され、「特定重要設備の導入」やら「重要維持管理等の委託」などで事前届出が必要になるってことらしい。既存の枠組みに手続き要件を差し込んだ形。
...
ふつーのことしか書いてないが、AI利用におけるガバナンスの拠り所にはなるんだろう。
